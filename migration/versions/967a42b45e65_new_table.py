...
def downgrade() -> None:
    ...
    sa.Column('acquired_date', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['item_id'], ['items.item_id'], name='user_inventory_item_id_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], name='user_inventory_user_id_fkey'),
